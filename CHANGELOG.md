...
- Add versioned policy schema, monotonic global/project/CLI resolution, risk and performance budgets, provenance digests and receipt hash binding.
- Add canonical closed quality contract bundle, explicit metric null semantics, fail-closed v1 migration corpus and Loop quality-matrix/v2 conformance.
